      ...
      <div className="bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-24">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 sm:p-8 md:p-12 rounded-2xl shadow-md mb-16 sm:mb-20 md:mb-24"
          >
            ...
            <ul className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              {highlights.map((highlight, index) => (
                <li key={index} className="flex items-start gap-3">
                  <Utensils className="w-5 h-5 sm:w-6 sm:h-6 text-amante-pink flex-shrink-0 mt-1" />
                  <span className="text-sm sm:text-base text-white/80 leading-relaxed">{highlight}</span>
                </li>
              ))}
            </ul>
          </motion.div>
          ...
          >
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 sm:p-8 rounded-2xl shadow-md text-center hover:shadow-xl hover:bg-white/10 transition-all">
              ...
              <h3 className="font-heading text-lg sm:text-xl text-white mb-2">Timing</h3>
              <p className="text-sm sm:text-base text-white/70">12:00 PM - 11:00 PM Daily</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 sm:p-8 rounded-2xl shadow-md text-center hover:shadow-xl hover:bg-white/10 transition-all">
              <Users className="w-10 h-10 sm:w-12 sm:h-12 text-amante-pink mx-auto mb-4" />
              <h3 className="font-heading text-lg sm:text-xl text-white mb-2">Capacity</h3>
              <p className="text-sm sm:text-base text-white/70">Up to 120 guests</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 sm:p-8 rounded-2xl shadow-md text-center hover:shadow-xl hover:bg-white/10 transition-all">
              <DollarSign className="w-10 h-10 sm:w-12 sm:h-12 text-amante-pink mx-auto mb-4" />
              <h3 className="font-heading text-lg sm:text-xl text-white mb-2">Price Range</h3>
