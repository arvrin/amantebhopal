      ...
      <div className="relative h-full w-full">
        ...
        <div className="relative h-full flex items-center justify-center px-4 sm:px-6">
          <div className="text-center max-w-5xl w-full">
            ...
            >
              <h1 className="font-heading text-3xl xs:text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-white mb-3 xs:mb-4 sm:mb-6 tracking-tight leading-tight px-2">
                Where Love<br />
            ...
            <motion.p
              ...
              className="font-body text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-amante-pink-light mb-6 xs:mb-8 sm:mb-12 max-w-3xl mx-auto px-4"
            >
            ...
            <motion.div
              ...
              className="absolute bottom-16 xs:bottom-20 sm:bottom-28 md:bottom-32 left-0 right-0 overflow-hidden py-2 xs:py-2.5 sm:py-3 bg-gradient-to-r from-[#8B1538]/90 via-[#7A1230]/90 to-[#6B0F28]/90 backdrop-blur-lg shadow-2xl"
            >
              <div className="scrolling-text whitespace-nowrap text-white text-[10px] xs:text-xs sm:text-sm md:text-base font-serif tracking-[0.25em] xs:tracking-[0.35em] uppercase">
            ...
            >
              <div className="flex items-center justify-center gap-2 xs:gap-3 sm:gap-6">
                <a
                  ...
                  className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 border border-white/20 hover:border-white/40"
                >
                  <Instagram className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 text-white" />
                </a>
                <a
                  ...
                  className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 border border-white/20 hover:border-white/40"
                >
                  <Facebook className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 text-white" />
                </a>
                <a
                  ...
                  className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 border border-white/20 hover:border-white/40"
                >
                  <Youtube className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 text-white" />
                </a>

                {/* Separator */}
                <div className="h-6 xs:h-8 w-px bg-white/20 mx-1 xs:mx-2"></div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[9px] xs:text-[10px] sm:text-xs text-white/60 hover:text-white/90 transition-colors duration-300"
                >
